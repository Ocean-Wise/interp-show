...
const images = {
  ...
  cat: require('../assets/confusedCat.jpg')
};
      ...
      <Deck transition={['zoom', 'slide']} theme={theme} transitionDuration={500}>
        <Slide transition={['zoom']} bgColor="primary">
          ...
          <Heading size={1} fit caps>
            A new ReactJS based Presentation Library for VanAqua Interps
          </Heading>
          <Heading size={1} fit caps textColor="black">
            Slides can be written In JSX (I can create the presentations for you!)
          </Heading>
        ...
        >
          <Image src={images.cat.replace('/', '')} margin="0px auto 40px" />
...
* Imported Markdown from another file
        ...
        <SlideSet>
          ...
          <Slide transition={['fade']} bgColor="primay">
            <Heading size={1} caps fit textColor="tertiary">
              You can even have videos!
            </Heading>
            <Videos/>
          </Slide>
        </SlideSet>
        ...
        >
          <Heading size={1} caps fit textColor="tertiary">and tables! (or any data structure, really)</Heading>
          <Heading size={4} caps textColor="secondary" bgColor="white" margin={25}>
            Pizza Toppings
          </Heading>
          <Layout>
            <Table>
